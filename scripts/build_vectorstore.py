...
def build_vectorstore(data_dir, vectorstore_path, embedding_model, ollama_base_url, 
    ...
    console.print(f"[green]✓[/green] Vector store saved")
...
def main():
    ...
    parser.add_argument("--vectorstore-path", default="data/vectorstore", help="Output path")
    parser.add_argument("--embedding-model", default="nomic-embed-text", help="Embedding model")
    parser.add_argument("--ollama-base-url", default="http://localhost:11434", help="Ollama URL")
