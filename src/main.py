...
def display_response(response: str, verbose: bool = False, confidence: Optional[float] = None) -> None:
...
def run_single_query(agent, question: str, mode: AgentMode, verbose: bool = False) -> None:
...
def main() -> int:
    ...
    try:
        ...
        console.print("[dim]Run 'python scripts/build_vectorstore.py' to create the vector store.[/dim]")
        return 1
